...
[![pkg.go.dev](https://pkg.go.dev/badge/github.com/integrasdl/markdown)](https://pkg.go.dev/github.com/integrasdl/markdown)

Package `github.com/integrasdl/markdown` is a Go library for parsing Markdown text and rendering as HTML.
...
- https://pkg.go.dev/github.com/integrasdl/markdown : top level package
- https://pkg.go.dev/github.com/integrasdl/markdown/ast : defines abstract syntax tree of parsed markdown document
- https://pkg.go.dev/github.com/integrasdl/markdown/parser : parser
- https://pkg.go.dev/github.com/integrasdl/markdown/html : html renderer
...
https://github.com/integrasdl/mdtohtml is a command-line markdown to html
...
You can install it with:
    ...
    go get -u github.com/integrasdl/mdtohtml
...
- **Safety**. Markdown is paranoid when parsing, making it safe
  ...
  [this example](https://github.com/integrasdl/markdown#sanitize-untrusted-content).
...
Some tools using this package: https://pkg.go.dev/github.com/integrasdl/markdown?tab=importedby
